...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(RealtorApp.config.endpoints);

    var serviceConfig = $.extend(true, {}, RealtorApp.config.services, {
        db: {
    ...
    RealtorApp.db = new DevExpress.data.ODataContext(serviceConfig.db);
